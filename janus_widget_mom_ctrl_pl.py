...
################################################################################
## DEFINE CLASS "widget_mom_ctrl_pl" TO CUSTOMIZE "QWidget" FOR MOM. CONTROL.
################################################################################

class widget_mom_ctrl_pl( QWidget ) :
	...
	def __init__( self, core ) :
		...
		super( widget_mom_ctrl_pl, self ).__init__( )
		...
		self.lab_win_dir = QLabel( 'Directions:'    )
